...
<%@ page language ="java" %>
<%@page import = "webapp.modelo.Reservacion"%>
...
<script src="../../lumino/js/lumino.glyphs.js"></script>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">           
        ...
        <div class="row">
            <div class="col-lg-6">
                <h1 class="page-header">Reservacion</h1>
            </div>
            <div class="col-lg-6">
                <a href="/webapp/template/reservacion/create.jsp">
                            ...
                            <tbody>
                              ...
                              <%
                                    while (b.next()) {
                                        ...
                                        <td><%= b.getString("fecha_in") %></td>
                                         <td><%= b.getString("fecha_out") %></td>
                                          <td><%= b.getString("fecha_reservacion") %></td> 
                                          <td><%= b.getString("habitacion_id") %></td>
                                           <td><%= b.getString("cliente_id") %></td>
