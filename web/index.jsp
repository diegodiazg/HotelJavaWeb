<%-- 
    Document   : index
    Created on : Oct 14, 2016, 12:39:17 AM
    Author     : diego
--%>
...
<script src="lumino/js/lumino.glyphs.js"></script>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            ...
            <li><a href="template/cliente/create.jsp""><svg class="glyph stroked calendar"><use xlink:href="#stroked-calendar"></use></svg> Clientes</a></li>
